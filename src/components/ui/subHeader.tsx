...
export default function SubHeader() {
  ...
  return (
    <div className=" ">
      <div className="flex w-full text-xs xs:text-sm   gap-2 xs:gap-4 sm:text-lg sm:gap-8 md:gap-12 lg:gap-16 items-center justify-center py-5 font-normal border-b-2  border-[#4187C6]">
